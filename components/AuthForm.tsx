...
const AuthForm = ({ type }: { type: string }) => {
    ...
    return (
        <section className="auth-form">
            ...
            {user ?
                <div>
                    {/* LINKING BANK ACCOUNT PART USING PLAID  */}
                </div>
                :
                <>
                    <Form {...form}>
                            ...
                            {type === 'sign-up' && (
                                <>
                                    <div className="flex gap-4">
                                        ...
                                        <CustomInputForm control={form.control} name='lastName' label="Last Name" placeholder='Enter your first name' />
                                    </div>
                                    <CustomInputForm control={form.control} name='address' label="Address" placeholder='Enter your specific address' />
                                    ...
                                    <div className="flex gap-4">
                                        ...
                                        <CustomInputForm control={form.control} name='postalCode' label="Postal Code" placeholder='Example: 11101' />
                                    </div>
                                    <div className="flex gap-4">
